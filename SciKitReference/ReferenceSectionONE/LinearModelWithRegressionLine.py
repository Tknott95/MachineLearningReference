...
country_stats.to_csv('../Data/SectionONE_Data/prepared_after_train/LinModelRegLine_country_stats.csv',encoding='utf-8')
...
# # Step (7) Plot the Regression Model
point0, point1 = model.intercept_[0], model.coef_[0][0]
X = np.linspace(0, 110000, 1000)
plt.plot(X, point0 + point1 * X, "k")
plt.show()

# Step (8) Make prediction for cyprus
X_new=[[22587]]
