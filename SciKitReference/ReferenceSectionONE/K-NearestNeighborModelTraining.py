...
country_stats.to_csv('../Data/SectionONE_Data/prepared_after_train/KNearestNeighbor_country_stats.csv',encoding='utf-8')
...
# Step (5) Select a || K-Nearest Neighbors Model ||
